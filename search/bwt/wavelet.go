...
func (wt waveletTree) Access(i int) byte { _ = "STUB: not implemented"; return 0 }

// Rank allows us to get the rank of a specified character in
// the original string
func (wt waveletTree) Rank(char byte, i int) int { _ = "STUB: not implemented"; return 0 }

// Select allows us to get the corresponding position of a character
// in the original string given its rank.
func (wt waveletTree) Select(char byte, rank int) int { _ = "STUB: not implemented"; return 0 }

func (wt waveletTree) reconstruct() string { _ = "STUB: not implemented"; return "" }
...
func isInAlpha(alpha []charInfo, b byte) bool { _ = "STUB: not implemented"; return false }
...
func getCharInfoDescByRank(b []byte) []charInfo { _ = "STUB: not implemented"; return nil }

func encodeCharPathIntoBitVector(bv bitvector, n uint64) { _ = "STUB: not implemented"; return }

func getTreeHeight(alpha []charInfo) int { _ = "STUB: not implemented"; return 0 }

func validateWaveletTreeBuildInput(sequence *string) error { _ = "STUB: not implemented"; return nil }
